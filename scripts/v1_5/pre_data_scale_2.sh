...
# PRETRAIN_NAME=llava-v1.5-7b-pretrain-data-scale/llava-v1.5-7b-pretrain-allava-share4v-1M


# WANDB_PROJECT=pretrain MASTER_PORT=29516 deepspeed llava/train/train_mem.py \
...
PRETRAIN_NAME=llava-v1.5-7b-pretrain-data-scale/llava-v1.5-7b-pretrain-blip2-allava-200K
