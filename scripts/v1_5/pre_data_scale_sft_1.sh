...
PRETRAIN_NAME=llava-v1.5-7b-pretrain-data-scale/llava-v1.5-7b-pretrain-blip2-allava-1.2M
FINETUNE_NAME=llava-v1.5-7b-pretrain-data-scale/llava-v1.5-7b-pretrain-blip2-allava-1.2M-sft-llava-665K

WANDB_PROJECT=sft MASTER_PORT=29513 deepspeed llava/train/train_mem.py \
