...
PRETRAIN_NAME=llava-v1.5-7b-pretrain-data-quality/llava-v1.5-7b-pretrain-allava-share4v-in-blip-length-558K
FINETUNE_NAME=llava-v1.5-7b-pretrain-data-quality/llava-v1.5-7b-pretrain-allava-share4v-in-blip-length-558K-sft-llava-665K


WANDB_PROJECT=sft MASTER_PORT=29512 deepspeed llava/train/train_mem.py \
