PRETRAIN_NAME=llava-v1.5-7b-pretrain-unlock-settings/llava-v1.5-7b-pretrain-allava-share4v-1955K-mlp-only


WANDB_PROJECT=pretrain MASTER_PORT=29521 deepspeed llava/train/train_mem.py \
...
PRETRAIN_NAME=llava-v1.5-7b-pretrain-unlock-settings/llava-v1.5-7b-pretrain-allava-share4v-1955K-mlp-only
FINETUNE_NAME=llava-v1.5-7b-pretrain-unlock-settings/llava-v1.5-7b-pretrain-allava-share4v-1955K-mlp-only-sft-llava-665K


WANDB_PROJECT=sft MASTER_PORT=29521 deepspeed llava/train/train_mem.py \
    --deepspeed ./scripts/zero3.json \
    --model_name_or_path /mnt/hwfile/mllm/chenlin/llava/pretrained/vicuna/vicuna-7b-v1.5 \
    --version v1 \
