...
PRETRAIN_NAME=llava-v1.5-7b-pretrain-mlp-num/llava-v1.5-7b-pretrain-llava-558K-mlp4x_gelu

WANDB_PROJECT=recipe-pretrain MASTER_PORT=29620 deepspeed llava/train/train_mem.py \
...
PRETRAIN_NAME=llava-v1.5-7b-pretrain-mlp-num/llava-v1.5-7b-pretrain-llava-558K-mlp4x_gelu
FINETUNE_NAME=llava-v1.5-7b-pretrain-mlp-num/llava-v1.5-7b-pretrain-llava-558K-mlp4x_gelu-sft-llava-665K


WANDB_PROJECT=recipe-sft MASTER_PORT=29620 deepspeed llava/train/train_mem.py \
    --deepspeed ./scripts/zero3.json \
    --model_name_or_path /mnt/hwfile/mllm/chenlin/llava/pretrained/vicuna/vicuna-7b-v1.5 \
    --version v1 \
