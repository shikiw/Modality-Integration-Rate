...
# PRETRAIN_NAME=llava-v1.5-7b-pretrain-unlock-settings/llava-v1.5-7b-pretrain-allava-share4v-1955K-unlock-vit_12-llm_peft_unload


# WANDB_PROJECT=pretrain MASTER_PORT=29528 deepspeed llava/train/train_mem.py \
#     --lora_enable True --lora_r 128 --lora_alpha 256 --lora_merge_weights True --mm_projector_lr 2e-5 \
...
PRETRAIN_NAME=llava-v1.5-7b-pretrain-unlock-settings/llava-v1.5-7b-pretrain-allava-share4v-1955K-unlock-vit_12-llm_peft_unload
FINETUNE_NAME=llava-v1.5-7b-pretrain-unlock-settings/llava-v1.5-7b-pretrain-allava-share4v-1955K-unlock-vit_12-llm_peft_unload-sft-llava-665K


WANDB_PROJECT=sft MASTER_PORT=29528 deepspeed llava/train/train_mem.py \
    --deepspeed ./scripts/zero3.json \
