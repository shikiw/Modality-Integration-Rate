...
PRETRAIN_NAME=llava-v1.5-7b-pretrain-convergence/llava-v1.5-7b-pretrain-1epoch

WANDB_PROJECT=pertrain-convergence MASTER_PORT=29520 deepspeed llava/train/train_mem.py \
