...
PRETRAIN_NAME=llava-v1.5-7b-pretrain-unlock-settings/llava-v1.5-7b-pretrain-allava-share4v-1955K-unlock-llm_all


WANDB_PROJECT=pretrain MASTER_PORT=29523 deepspeed llava/train/train_mem.py \
...
PRETRAIN_NAME=llava-v1.5-7b-pretrain-unlock-settings/llava-v1.5-7b-pretrain-allava-share4v-1955K-unlock-llm_all
FINETUNE_NAME=llava-v1.5-7b-pretrain-unlock-settings/llava-v1.5-7b-pretrain-allava-share4v-1955K-unlock-llm_all-sft-llava-665K


WANDB_PROJECT=sft MASTER_PORT=29523 deepspeed llava/train/train_mem.py \
    --deepspeed ./scripts/zero3.json \
