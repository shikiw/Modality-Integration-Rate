...
PRETRAIN_NAME=llava-v1.5-7b-pretrain-ours2-mod_loss_l16_1e-3_new
FINETUNE_NAME=llava-v1.5-7b-sft-ours2-mod_loss_l16_1e-3_new


WANDB_PROJECT=pretrain-mod-loss MASTER_PORT=29598 deepspeed llava/train/train_mem.py \
...
WANDB_PROJECT=sft-mod-loss MASTER_PORT=29598 deepspeed llava/train/train_mem.py \
