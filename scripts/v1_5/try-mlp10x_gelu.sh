...
WANDB_PROJECT=pretrain-mlp10x_gelu MASTER_PORT=29508 deepspeed llava/train/train_mem.py \
    ...
    --mm_projector_type mlp10x_gelu \
    --tune_mm_mlp_adapter True \
    --mm_vision_select_layer -2 \
    --mm_use_im_start_end False \
    --mm_use_im_patch_token False \
    --bf16 True \
    --output_dir ./checkpoints/llava-v1.5-7b-pretrain-mlp10x_gelu \
    --num_train_epochs 1 \
...
WANDB_PROJECT=pretrain-mlp10x_gelu MASTER_PORT=29508 deepspeed llava/train/train_mem.py \
    ...
    --pretrain_mm_mlp_adapter ./checkpoints/llava-v1.5-7b-pretrain-mlp10x_gelu/mm_projector.bin \
    --mm_projector_type mlp10x_gelu \
    --mm_vision_select_layer -2 \
    --mm_use_im_start_end False \
    --mm_use_im_patch_token False \
    ...
    --bf16 True \
    --output_dir ./checkpoints/llava-v1.5-7b-sft-mlp10x_gelu \
    --num_train_epochs 1 \
