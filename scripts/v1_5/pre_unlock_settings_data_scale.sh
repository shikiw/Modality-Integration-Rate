...
do
    ...
    WANDB_PROJECT=unlock-data-scale MASTER_PORT=29510 deepspeed llava/train/train_mem.py \
...
do
    ...
    WANDB_PROJECT=sft MASTER_PORT=29510 deepspeed llava/train/train_mem.py \
        --deepspeed ./scripts/zero3.json \
