...
PRETRAIN_NAME=llava-v1.5-7b-pretrain-ours2-new
FINETUNE_NAME=llava-v1.5-7b-sft-ours2-new


WANDB_PROJECT=pretrain-mm-norm MASTER_PORT=29577 deepspeed llava/train/train_mem.py \
...
WANDB_PROJECT=sft-mm-norm MASTER_PORT=29577 deepspeed llava/train/train_mem.py \
