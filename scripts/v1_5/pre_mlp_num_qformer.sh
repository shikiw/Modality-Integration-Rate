...
PRETRAIN_NAME=llava-v1.5-7b-pretrain-mlp-num/llava-v1.5-7b-pretrain-llava-558K-qformer1

WANDB_PROJECT=module-pretrain MASTER_PORT=29520 deepspeed llava/train/train_mem.py \
...
PRETRAIN_NAME=llava-v1.5-7b-pretrain-mlp-num/llava-v1.5-7b-pretrain-llava-558K-qformer1
FINETUNE_NAME=llava-v1.5-7b-pretrain-mlp-num/llava-v1.5-7b-pretrain-llava-558K-qformer1-sft-llava-665K
